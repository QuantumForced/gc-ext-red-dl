...
// const classWorkerURL = chrome.runtime.getURL("lib/ffmpeg/ffmpeg-core.worker.js");
// const coreWorkerUrl = chrome.runtime.getURL("lib/ffmpeg/ffmpeg-core.worker.js");
// const worker814URL = chrome.runtime.getURL("lib/ffmpeg/umd/814.ffmpeg.js");
// const workerUrl = chrome.runtime.getURL("lib/ffmpeg/esm/worker.js");

async function dl_video_ffmpeg(linkUrl) {
    try {
        if (linkUrl) {
...
async function downloadFile(blob, fileName) {
    try {
        ...
        document.body.appendChild(dl); // Optionally add the anchor to the document
        dl.click();
        URL.revokeObjectURL(dl.href); // Clean up the object URL
        document.body.removeChild(dl); // Optionally remove the anchor from the document
        return true;
    } catch (error) {
